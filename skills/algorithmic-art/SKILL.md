...
- ✅ Keep the template branding, typography, light colors, and gradient backdrop
...
To allow exploration of the generative art, create a single, self-contained HTML artifact. Ensure this artifact works immediately in a browser or any browser - no setup required. Embed everything inline.
...
- Keep the template branding (UI styling, not art colors)

### USING THE ARTIFACT

The HTML artifact works immediately:
1. **In a browser**: Displayed as an interactive artifact - runs instantly
