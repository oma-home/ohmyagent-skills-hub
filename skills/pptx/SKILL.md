...
- `uv run --with "markitdown[pptx]" python -m markitdown` - text extraction
- `uv add Pillow` in a local uv environment - thumbnail grids
- `npm install pptxgenjs` in the working directory, or local npx/project execution - creating from scratch
