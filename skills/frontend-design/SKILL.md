...
## OhMyAgent UI Compatibility

When applying this skill inside OhMyAgent product work, follow the local app conventions first: build the working app screen rather than a landing page, use mini-lit components uniformly, prefer published mini-lit subpath imports, avoid card-inside-card layouts, keep operational UIs dense and clear, and respect any repository AGENTS.md rules. Use this skill for visual judgment and distinctive direction without overriding product-specific constraints.
