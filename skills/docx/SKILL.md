...
Generate .docx files with JavaScript, then validate. Use a local project dependency or one-off local execution, for example `npm install docx` in the working directory for the generated script. Do not require global npm installs.
...
- **docx**: install locally in the working directory with `npm install docx`, or use a local project dependency for generated scripts (new documents)
